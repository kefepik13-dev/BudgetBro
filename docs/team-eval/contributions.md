...
Zur Aufbereitung der Finanzdaten entwickelte ich komplexe Business-Logik-Module, die Einnahmen, Fixkosten und Sparquoten dynamisch aggregieren. Als besonderes Feature integrierte ich **Plotly**, um diese Datenströme in interaktive **Sankey-Diagramme** zu übersetzen, die dem Nutzer eine intuitive Visualisierung seiner Finanzflüsse ermöglichen.
## [Efe Kürsat Epik]
