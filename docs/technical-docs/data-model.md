...
- `onboarding_done` (Boolean), um zu prüfen, ob der Nutzer das Onboarding abgeschlossen hat

**Status:**  
Dieses Modell ist vollständig implementiert und bereits in Nutzung.
...
**Status:**  
Diese Modelle befinden sich noch in Bearbeitung und werden in kommenden Updates vollständig integriert.
...
Der **User** ist die zentrale Entität und wird mit allen anderen Modellen verknüpft.

**Status:**  
Die Verknüpfungen werden umgesetzt, sobald die jeweiligen Modelle vollständig implementiert sind.
